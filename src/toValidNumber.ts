 ...
 */
type ToValidNumberOptions<T extends z.ZodTypeAny = z.ZodNumber, K = null> = {
  /**
...
export function toValidNumber<T extends z.ZodTypeAny = z.ZodNumber, K = null>(
  type: T,
...
export function toValidNumber<T extends z.ZodTypeAny, K>(
