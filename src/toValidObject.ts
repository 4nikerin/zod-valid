 ...
 */
type ToValidObjectOptions<T extends z.ZodTypeAny = z.ZodObject, K = null> = {
  /**
...
export function toValidObject<T extends z.ZodTypeAny = z.ZodObject, K = null>(
  type: T,
...
export function toValidObject<T extends z.ZodTypeAny, K>(
